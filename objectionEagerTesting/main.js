...
app.get('/persons/test/get', async (req, res) => {
  
  const persons = await Person.query()
  .eager('address.street')
  .leftJoinRelation('address.street').where('pinCode','=','457001')
  .groupBy('persons.id')
  .modifyEager('address.street' , builder=>{
    builder.where('pinCode','=','457001');
  }) 
